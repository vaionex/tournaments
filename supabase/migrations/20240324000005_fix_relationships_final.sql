...
ALTER TABLE hardware_reviews DROP CONSTRAINT IF EXISTS hardware_reviews_author_id_fkey;
ALTER TABLE game_reviews DROP CONSTRAINT IF EXISTS game_reviews_author_id_fkey;
...
-- Update null authors to system user
UPDATE articles 
