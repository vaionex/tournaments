		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			<div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 py-8">
				...
				<div class="flex flex-wrap items-center gap-4 text-sm text-gray-600 dark:text-gray-400 mb-6 pb-6 border-b-2 border-gray-200 dark:border-gray-700">
					...
					<div class="flex items-center gap-1">
						...
						<span>{article?.sport?.toUpperCase() || 'SPORTS'}</span>
					</div>
				</div>
			</header>
					...
					<div class="prose prose-lg dark:prose-invert max-w-none mb-12">
						...
						<div class="space-y-6 text-gray-800 dark:text-gray-200 leading-relaxed">
							{#each paragraphs as paragraph, i}
								...
								<!-- Inline YouTube embed at configured position -->
								{#if article?.youtubeVideoId && (article.videoPosition === 'after-paragraph-2' && i === 1 || article.videoPosition === 'after-paragraph-3' && i === 2)}
									<div class="my-10">
										<div class="flex items-center gap-2 mb-3">
											<div class="flex items-center justify-center w-8 h-8 bg-red-600 rounded-lg flex-shrink-0">
												<svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
			...
			{/if}
				...
				<div class="flex gap-3">
					...
					<button class="flex items-center gap-2 px-4 py-2 bg-black hover:bg-gray-900 text-white rounded-lg font-semibold transition-colors">
						<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
			...
			<aside class="lg:col-span-1 space-y-8">
				...
				<div class="bg-white dark:bg-gray-800 rounded-2xl border-2 border-gray-200 dark:border-gray-700 p-6">
					...
					<div class="flex gap-3">
						...
						<a href="https://x.com" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center w-10 h-10 bg-black hover:bg-gray-800 text-white rounded-lg transition-colors" aria-label="Follow us on X">
							<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
