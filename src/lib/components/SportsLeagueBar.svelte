		...
		<div class="flex items-center h-11 sm:h-12 gap-1 sm:gap-2">
			...
			<div class="flex items-center gap-1 sm:gap-2 flex-shrink-0">
				...
				<div class="hidden sm:flex items-center gap-1 border-l border-gray-600 pl-2 ml-1">
					...
					<a href="/athletes" class="flex items-center gap-1.5 text-white dark:text-gray-200 hover:text-red-400 transition-colors text-xs font-semibold px-2 py-1.5 rounded hover:bg-gray-700">
						<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					...
					<a href="/whats-on" class="flex items-center gap-1.5 text-white dark:text-gray-200 hover:text-red-400 transition-colors text-xs font-semibold px-2 py-1.5 rounded hover:bg-gray-700">
						<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
						</svg>
						<span class="hidden lg:inline">What's On</span>
					</a>
